...
**     Date/Time   : 2015-02-07, 07:39, # CodeGen: 11
**     Abstract    :
**          Contains various utility functions.
**     Settings    :
**          Component name                                 : UTIL
**     Contents    :
**         strcpy                  - void UTIL_strcpy(uint8_t *dst, size_t dstSize, const unsigned char *src);
**         strcat                  - void UTIL_strcat(uint8_t *dst, size_t dstSize, const unsigned char *src);
**         chcat                   - void UTIL_chcat(uint8_t *dst, size_t dstSize, uint8_t ch);
**         Num8sToStr              - void UTIL_Num8sToStr(uint8_t *dst, size_t dstSize, signed char val);
**         Num8uToStr              - void UTIL_Num8uToStr(uint8_t *dst, size_t dstSize, uint8_t val);
**         Num16sToStr             - void UTIL_Num16sToStr(uint8_t *dst, size_t dstSize, int16_t val);
**         Num16uToStr             - void UTIL_Num16uToStr(uint8_t *dst, size_t dstSize, uint16_t val);
**         Num32uToStr             - void UTIL_Num32uToStr(uint8_t *dst, size_t dstSize, uint32_t val);
**         Num32sToStr             - void UTIL_Num32sToStr(uint8_t *dst, size_t dstSize, int32_t val);
**         Num16sToStrFormatted    - void UTIL_Num16sToStrFormatted(uint8_t *dst, size_t dstSize, int16_t val,...
**         Num16uToStrFormatted    - void UTIL_Num16uToStrFormatted(uint8_t *dst, size_t dstSize, uint16_t val,...
**         Num32uToStrFormatted    - void UTIL_Num32uToStrFormatted(uint8_t *dst, size_t dstSize, uint32_t val,...
**         Num32sToStrFormatted    - void UTIL_Num32sToStrFormatted(uint8_t *dst, size_t dstSize, int32_t val,...
**         strcatNum8u             - void UTIL_strcatNum8u(uint8_t *dst, size_t dstSize, uint8_t val);
**         strcatNum8s             - void UTIL_strcatNum8s(uint8_t *dst, size_t dstSize, signed char val);
**         strcatNum16u            - void UTIL_strcatNum16u(uint8_t *dst, size_t dstSize, uint16_t val);
**         strcatNum16s            - void UTIL_strcatNum16s(uint8_t *dst, size_t dstSize, int16_t val);
**         strcatNum32u            - void UTIL_strcatNum32u(uint8_t *dst, size_t dstSize, uint32_t val);
**         strcatNum32s            - void UTIL_strcatNum32s(uint8_t *dst, size_t dstSize, int32_t val);
**         strcatNum16uFormatted   - void UTIL_strcatNum16uFormatted(uint8_t *dst, size_t dstSize, uint16_t val,...
**         strcatNum16sFormatted   - void UTIL_strcatNum16sFormatted(uint8_t *dst, size_t dstSize, int16_t val,...
**         strcatNum32uFormatted   - void UTIL_strcatNum32uFormatted(uint8_t *dst, size_t dstSize, uint32_t val,...
**         strcatNum32sFormatted   - void UTIL_strcatNum32sFormatted(uint8_t *dst, size_t dstSize, int32_t val,...
**         strcatNum8Hex           - void UTIL_strcatNum8Hex(uint8_t *dst, size_t dstSize, uint8_t num);
**         strcatNum16Hex          - void UTIL_strcatNum16Hex(uint8_t *dst, size_t dstSize, uint16_t num);
**         strcatNum24Hex          - void UTIL_strcatNum24Hex(uint8_t *dst, size_t dstSize, uint32_t num);
**         strcatNum32Hex          - void UTIL_strcatNum32Hex(uint8_t *dst, size_t dstSize, uint32_t num);
**         strcatNum32sDotValue100 - void UTIL_strcatNum32sDotValue100(uint8_t *dst, size_t dstSize, int32_t num);
**         IsLeapYear              - bool UTIL_IsLeapYear(uint16_t year);
**         WeekDay                 - byte UTIL_WeekDay(uint16_t year, uint8_t month, uint8_t day);
**         ReadEscapedName         - byte UTIL_ReadEscapedName(const unsigned char *filename, uint8_t *destname,...
**         xatoi                   - byte UTIL_xatoi(const unsigned char **str, int32_t *res);
**         ScanDate                - byte UTIL_ScanDate(const unsigned char **str, uint8_t *day, uint8_t *month,...
**         ScanTime                - byte UTIL_ScanTime(const unsigned char **str, uint8_t *hour, uint8_t *minute,...
**         ScanDecimal8uNumber     - byte UTIL_ScanDecimal8uNumber(const unsigned char **str, uint8_t *val);
**         ScanDecimal8sNumber     - byte UTIL_ScanDecimal8sNumber(const unsigned char **str, signed char *val);
...
**         ScanHex32uNumber        - uint8_t UTIL_ScanHex32uNumber(const unsigned char **str, uint32_t *val);
**         ScanSeparatedNumbers    - uint8_t UTIL_ScanSeparatedNumbers(const unsigned char **str, uint8_t *values,...
**         strcmp                  - int16_t UTIL_strcmp(const char *, const char *);
**         strncmp                 - int16_t UTIL_strncmp(const char *, const char *, size_t size);
**         strFind                 - int16_t UTIL_strFind(uint8_t *str, uint8_t *subStr);
**         strtailcmp              - byte UTIL_strtailcmp(uint8_t *str, uint8_t *tail);
**         strlen                  - word UTIL_strlen(const char *);
**         strCutTail              - byte UTIL_strCutTail(uint8_t *str, uint8_t *tail);
**
...
*/         
/*!
**  @addtogroup UTIL_module UTIL module documentation
**  @{
*/         
...
/*
** ===================================================================
**     Method      :  UTIL_strcpy (component Utility)
**     Description :
...
*/
void UTIL_strcpy(uint8_t *dst, size_t dstSize, const unsigned char *src)
{
...
/*
** ===================================================================
**     Method      :  UTIL_strcat (component Utility)
**     Description :
...
/*
** ===================================================================
**     Method      :  UTIL_chcat (component Utility)
**     Description :
...
** ===================================================================
*/
void UTIL_chcat(uint8_t *dst, size_t dstSize, uint8_t ch)
{
  dstSize--; /* for zero uint8_t */
  /* point to the end of the source */
  while (dstSize > 0 && *dst != '\0') {
...
/*
** ===================================================================
**     Method      :  UTIL_Num8uToStr (component Utility)
**     Description :
...
{
  UTIL_Num16uToStr(dst, dstSize, (uint16_t)val);
}

/*
** ===================================================================
**     Method      :  UTIL_Num8sToStr (component Utility)
**     Description :
 ...
 */
void UTIL_Num8sToStr(uint8_t *dst, size_t dstSize, signed char val)
{
  UTIL_Num16sToStr(dst, dstSize, (int16_t)val);
}

/*
** ===================================================================
**     Method      :  UTIL_Num16uToStr (component Utility)
**     Description :
 ...
 */
void UTIL_Num16uToStr(uint8_t *dst, size_t dstSize, uint16_t val)
{
...
/*
** ===================================================================
**     Method      :  UTIL_Num16sToStr (component Utility)
**     Description :
**         Converts a signed 16bit value into a string.
**     Parameters  :
**         NAME            - DESCRIPTION
 ...
 */
void UTIL_Num16sToStr(uint8_t *dst, size_t dstSize, int16_t val)
{
  unsigned char *ptr =  ((unsigned char *)dst);
  unsigned char i=0, j;
  unsigned char tmp;
  ...
  if (val==(int16_t)(0x8000)) { /* special case 0x8000/-32768: prevent overflow below. */
    UTIL_strcpy(dst, dstSize, (unsigned char*)"-32768");
    return;
  }
  dstSize--; /* for zero uint8_t */
  if (sign) {
...
/*
** ===================================================================
**     Method      :  UTIL_Num16sToStrFormatted (component Utility)
**     Description :
...
*/
void UTIL_Num16sToStrFormatted(uint8_t *dst, size_t dstSize, int16_t val, char fill, uint8_t nofFill)
{
  UTIL_Num16sToStr(dst, dstSize, val);
  ShiftRightAndFill(dst, fill, nofFill);
}

/*
** ===================================================================
**     Method      :  UTIL_Num16uToStrFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void UTIL_Num16uToStrFormatted(uint8_t *dst, size_t dstSize, uint16_t val, char fill, uint8_t nofFill)
{
  UTIL_Num16uToStr(dst, dstSize, val);
  ShiftRightAndFill(dst, fill, nofFill);
}

/*
** ===================================================================
**     Method      :  UTIL_Num32uToStrFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void UTIL_Num32uToStrFormatted(uint8_t *dst, size_t dstSize, uint32_t val, char fill, uint8_t nofFill)
{
  UTIL_Num32uToStr(dst, dstSize, val);
  ShiftRightAndFill(dst, fill, nofFill);
}

/*
** ===================================================================
**     Method      :  UTIL_Num32sToStrFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void UTIL_Num32sToStrFormatted(uint8_t *dst, size_t dstSize, int32_t val, char fill, uint8_t nofFill)
{
  UTIL_Num32sToStr(dst, dstSize, val);
  ShiftRightAndFill(dst, fill, nofFill);
}

/*
** ===================================================================
**     Method      :  UTIL_strcatNum8u (component Utility)
**     Description :
...
/*!
  ...
  */
void UTIL_strcatNum8u(uint8_t *dst, size_t dstSize, uint8_t val)
{
  unsigned char buf[sizeof("256")]; /* maximum buffer size we need */

  UTIL_Num8uToStr(buf, sizeof(buf), val);
  UTIL_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  UTIL_strcatNum8s (component Utility)
**     Description :
...
/*!
  ...
  */
void UTIL_strcatNum8s(uint8_t *dst, size_t dstSize, signed char val)
{
  unsigned char buf[sizeof("-128")]; /* maximum buffer size we need */

  UTIL_Num8sToStr(buf, sizeof(buf), val);
  UTIL_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  UTIL_strcatNum16u (component Utility)
**     Description :
...
/*!
  ...
  \param[in] val The 16bit unsigned number to add
  */
void UTIL_strcatNum16u(uint8_t *dst, size_t dstSize, uint16_t val)
{
  unsigned char buf[sizeof("32768")]; /* maximum buffer size we need */

  UTIL_Num16uToStr(buf, sizeof(buf), val);
  UTIL_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  UTIL_strcatNum16s (component Utility)
**     Description :
...
/*!
  ...
  \param[in] val The 16bit signed number to add
  */
void UTIL_strcatNum16s(uint8_t *dst, size_t dstSize, int16_t val)
{
  unsigned char buf[sizeof("-32768")]; /* maximum buffer size we need */

  UTIL_Num16sToStr(buf, sizeof(buf), val);
  UTIL_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  UTIL_strcatNum16uFormatted (component Utility)
**     Description :
...
/*!
  ...
  */
void UTIL_strcatNum16uFormatted(uint8_t *dst, size_t dstSize, uint16_t val, char fill, uint8_t nofFill)
{
  unsigned char buf[sizeof("32768")]; /* maximum buffer size we need */

  UTIL_Num16uToStrFormatted(buf, dstSize, val, fill, nofFill);
  UTIL_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  UTIL_strcatNum16sFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void UTIL_strcatNum16sFormatted(uint8_t *dst, size_t dstSize, int16_t val, char fill, uint8_t nofFill)
{
  unsigned char buf[sizeof("-32768")]; /* maximum buffer size we need */

  UTIL_Num16sToStrFormatted(buf, dstSize, val, fill, nofFill);
  UTIL_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  UTIL_strcatNum32uFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void UTIL_strcatNum32uFormatted(uint8_t *dst, size_t dstSize, uint32_t val, char fill, uint8_t nofFill)
{
  unsigned char buf[sizeof("4294967295")]; /* maximum buffer size we need */

  UTIL_Num32uToStrFormatted(buf, dstSize, val, fill, nofFill);
  UTIL_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  UTIL_strcatNum32sFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void UTIL_strcatNum32sFormatted(uint8_t *dst, size_t dstSize, int32_t val, char fill, uint8_t nofFill)
{
  unsigned char buf[sizeof("-4294967295")]; /* maximum buffer size we need */

  UTIL_Num32sToStrFormatted(buf, dstSize, val, fill, nofFill);
  UTIL_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  UTIL_strcatNum8Hex (component Utility)
**     Description :
...
/*!
  ...
  */
void UTIL_strcatNum8Hex(uint8_t *dst, size_t dstSize, uint8_t num)
{
...
/*
** ===================================================================
**     Method      :  UTIL_strcatNum16Hex (component Utility)
**     Description :
...
/*!
  ...
  */
void UTIL_strcatNum16Hex(uint8_t *dst, size_t dstSize, uint16_t num)
{
...
/*
** ===================================================================
**     Method      :  UTIL_strcatNum24Hex (component Utility)
**     Description :
...
/*!
  ...
  */
void UTIL_strcatNum24Hex(uint8_t *dst, size_t dstSize, uint32_t num)
{
...
/*
** ===================================================================
**     Method      :  UTIL_strcatNum32Hex (component Utility)
**     Description :
**         Appends a 16bit unsigned value to a buffer as hex number
**         (without a 0x prefix).
**     Parameters  :
...
/*!
  ...
  */
void UTIL_strcatNum32Hex(uint8_t *dst, size_t dstSize, uint32_t num)
{
...
/*
** ===================================================================
**     Method      :  UTIL_strcatNum32s (component Utility)
**     Description :
...
/*!
  ...
  */
void UTIL_strcatNum32s(uint8_t *dst, size_t dstSize, int32_t val)
{
  unsigned char buf[sizeof("-4294967295")]; /* maximum buffer size we need */

  UTIL_Num32sToStr(buf, sizeof(buf), val);
  UTIL_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  UTIL_strcatNum32u (component Utility)
**     Description :
**         Appends a 32bit signed value to a string buffer.
**     Parameters  :
**         NAME            - DESCRIPTION
...
/*!
  ...
  \param[in] val The 32bit unsigned number to add
  */
void UTIL_strcatNum32u(uint8_t *dst, size_t dstSize, uint32_t val)
{
  unsigned char buf[sizeof("4294967295")]; /* maximum buffer size we need */

  UTIL_Num32uToStr(buf, sizeof(buf), val);
  UTIL_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  UTIL_Num32sToStr (component Utility)
**     Description :
 ...
 */
void UTIL_Num32sToStr(uint8_t *dst, size_t dstSize, int32_t val)
{
  unsigned char *ptr = ((unsigned char *)dst);
  unsigned char i=0, j;
  unsigned char tmp;
  ...
  if (val==(int32_t)(0x80000000)) { /* special case 0x80000000/-2147483648: prevent overflow below. */
    UTIL_strcpy(dst, dstSize, (unsigned char*)"-2147483648");
    return;
  }
  dstSize--; /* for zero uint8_t */
  if (sign) {
...
/*
** ===================================================================
**     Method      :  UTIL_Num32uToStr (component Utility)
**     Description :
...
/*
** ===================================================================
**     Method      :  UTIL_IsLeapYear (component Utility)
**     Description :
...
** ===================================================================
*/
bool UTIL_IsLeapYear(uint16_t year)
{
...
/*
** ===================================================================
**     Method      :  UTIL_WeekDay (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_WeekDay(uint16_t year, uint8_t month, uint8_t day)
{
  ...
  sum += sum/4;
  sum %= 7;
  if (UTIL_IsLeapYear(year) && (month==1 || month==2)) {
    sum--;
  }
  sum += day;
  sum %= 7;
...
/*
** ===================================================================
**     Method      :  UTIL_ReadEscapedName (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ReadEscapedName(const unsigned char *filename, uint8_t *destname, size_t maxlen, size_t *lenRead, size_t *lenWritten, const char *terminators)
{
...
/*
** ===================================================================
**     Method      :  UTIL_xatoi (component Utility)
**     Description :
...
#endif
uint8_t UTIL_xatoi(const unsigned char **str, int32_t *res)
{
...
/*
** ===================================================================
**     Method      :  UTIL_ScanDate (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ScanDate(const unsigned char **str, uint8_t *day, uint8_t *month, uint16_t *year)
{
  ...
  if (   UTIL_ScanDecimal8uNumber(&p, day)==ERR_OK
      && *day > 0 && *day <= 31
      && (*p=='.' || *p=='-')
     )
  {
    p++;
    if (   UTIL_ScanDecimal8uNumber(&p, month)==ERR_OK
        && *month > 0 && *month <= 12
        && (*p=='.' || *p=='-')
       )
    {
      p++;
      if (   UTIL_ScanDecimal16uNumber(&p, year)==ERR_OK
...
/*
** ===================================================================
**     Method      :  UTIL_ScanTime (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ScanTime(const unsigned char **str, uint8_t *hour, uint8_t *minute, uint8_t *second, uint8_t *hSecond)
{
  ...
  *hSecond = 0;
  ...
  if (   UTIL_ScanDecimal8uNumber(&p, hour)==ERR_OK
      && *hour <= 24
      && *p==':'
     )
  {
    p++; /* skip ':' */
    if (   UTIL_ScanDecimal8uNumber(&p, minute)==ERR_OK
        && *minute <= 60
       )
    {
      if (*p==':') { /* there is more after the minute */
        p++; /* skip ':' */
        if (   UTIL_ScanDecimal8uNumber(&p, second)==ERR_OK
            && *second <= 60
           )
        {
...
/*
** ===================================================================
**     Method      :  UTIL_ScanDecimal8uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ScanDecimal8uNumber(const unsigned char **str, uint8_t *val)
{
...
/*
** ===================================================================
**     Method      :  UTIL_ScanDecimal8sNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ScanDecimal8sNumber(const unsigned char **str, signed char *val)
{
  ...
  *val = 0;
  ...
  res = UTIL_ScanDecimal8uNumber(&p, &val8u);
  if (res != ERR_OK) {
    return res;
  }
  if (isNeg) {
...
/*
** ===================================================================
**     Method      :  UTIL_ScanDecimal16uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ScanDecimal16uNumber(const unsigned char **str, uint16_t *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  UTIL_ScanDecimal16sNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ScanDecimal16sNumber(const unsigned char **str, int16_t *val)
{
  /* Scans a decimal number, and stops at any non-number. Number can have any preceding spaces. */
  const unsigned char *p = *str;
  bool isNeg;
  ...
  *val = 0;
  ...
  res = UTIL_ScanDecimal16uNumber(&p, (uint16_t*)&val16u);
  if (res != ERR_OK) {
    return res;
  }
  if (isNeg) {
...
/*
** ===================================================================
**     Method      :  UTIL_ScanDecimal32uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ScanDecimal32uNumber(const unsigned char **str, uint32_t *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  UTIL_ScanDecimal32sNumber (component Utility)
**     Description :
...
byte UTIL_ScanDecimal32sNumber(const unsigned char **str, int32_t *val)
{
  ...
  *val = 0;
  ...
  res = UTIL_ScanDecimal32uNumber(&p, &val32u);
  if (res != ERR_OK) {
    return res;
  }
  if (isNeg) {
...
/*
** ===================================================================
**     Method      :  UTIL_strcmp (component Utility)
**     Description :
...
*/
/***
int16_t UTIL_strcmp(const char *, const char *)
{
...
/*
** ===================================================================
**     Method      :  UTIL_strncmp (component Utility)
**     Description :
...
*/
/***
int16_t UTIL_strncmp(const char *, const char *, size_t size)
{
...
/*
** ===================================================================
**     Method      :  UTIL_strlen (component Utility)
**     Description :
...
*/
/***
uint16_t UTIL_strlen(const char *)
{
...
/*
** ===================================================================
**     Method      :  UTIL_ScanHex32uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ScanHex32uNumber(const unsigned char **str, uint32_t *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  UTIL_ScanHex16uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ScanHex16uNumber(const unsigned char **str, uint16_t *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  UTIL_ScanHex8uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ScanHex8uNumber(const unsigned char **str, uint8_t *val)
{
...
/*
** ===================================================================
**     Method      :  UTIL_ScanHex8uNumberNoPrefix (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ScanHex8uNumberNoPrefix(const unsigned char **str, uint8_t *val)
{
...
/*
** ===================================================================
**     Method      :  UTIL_strtailcmp (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_strtailcmp(uint8_t *str, uint8_t *tail)
{
  int i, j;

  i = (int)UTIL_strlen((char*)str);
  j = (int)UTIL_strlen((char*)tail);
...
/*
** ===================================================================
**     Method      :  UTIL_strCutTail (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_strCutTail(uint8_t *str, uint8_t *tail)
{
  /* cut the tail from the string */
  size_t strLen, tailLen;

  if (UTIL_strtailcmp(str, tail)!=0) { /* check if tail is present */
    return ERR_FAILED; /* tail not found */
  }
  tailLen = UTIL_strlen((char*)tail);
  strLen = UTIL_strlen((char*)str);
...
/*
** ===================================================================
**     Method      :  UTIL_strcatNum32sDotValue100 (component Utility)
**     Description :
...
** ===================================================================
*/
void UTIL_strcatNum32sDotValue100(uint8_t *dst, size_t dstSize, int32_t num)
{
  UTIL_strcatNum32s(dst, dstSize, num/100);
  UTIL_chcat(dst, dstSize, '.');
  if (num<0) {
    num = -num;
  }
  UTIL_strcatNum16uFormatted(dst, dstSize, (uint16_t)(num%100), '0', 2);
}

/*
** ===================================================================
**     Method      :  UTIL_strFind (component Utility)
**     Description :
...
/*
** ===================================================================
**     Method      :  UTIL_ScanSeparatedNumbers (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t UTIL_ScanSeparatedNumbers(const unsigned char **str, uint8_t *values, uint8_t nofValues, char separator, UTIL_SeparatedNumberType numberType)
{
  int i;
  uint8_t res;
  const unsigned char *p;
  ...
  for(i=0;i<nofValues;i++) {
    if (numberType==UTIL_SEP_NUM_TYPE_UINT8) {
      res = UTIL_ScanDecimal8uNumber(&p, &values[i]);
    } else if (numberType==UTIL_SEP_NUM_TYPE_UINT8_HEX_NO_PREFIX) {
      res = UTIL_ScanHex8uNumberNoPrefix(&p, &values[i]);
    } else {
      res = ERR_FAILED;
    }
